const intlLanguage =
  "Asia/Calcutta" === Intl.DateTimeFormat().resolvedOptions().timeZone
    ? "en-IN"
    : "en-US";
function unitChanged(e, t) {
  const c = document.getElementById("units1").value,
    a = document.getElementById("Price1").value,
    n = document.getElementById("units2").value,
    l = document.getElementById("Price2").value;
  "" != c && "" != a && "" != n && "" != l && getAverage(),
    "" == document.getElementById(e).value
      ? (document.getElementById(t).innerHTML = "Field is Required")
      ...
      if ("" != document.getElementById("units2").value)
        if ("" != document.getElementById("Price2").value) {
          ...
          (document.getElementById("investedamount1").innerHTML =
            "<span>The amount invested in the 1st purchase: </span>  <span class='unit-amount'>" +
            (e * t).toLocaleString(intlLanguage) +
            "</span>"),
            (document.getElementById("investedamount2").innerHTML =
              "<span>The amount invested in the 2nd purchase: </span> <span class='unit-amount'>" +
              (c * a).toLocaleString(intlLanguage) +
              "</span>"),
            (document.getElementById("result").innerHTML =
              "<span>Total units </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bold>" +
              l +
              "</bold><br/><br/><span>Average Price</span> &nbsp;&nbsp;&nbsp;<bold>" +
              d.toLocaleString(intlLanguage) +
              "</bold><br/><br/><span>Total Amount</span> &nbsp;&nbsp;&nbsp;<bold>" +
              n.toLocaleString(intlLanguage) +
              "</bold>");
  ...
  switch (e) {
    case "ac":
      document.getElementById("average-calculator").classList.remove("hide"),
        ...
        document
          .getElementById("percentage-calculator")
    ...
    case "sc":
      document.getElementById("sip-calculator").classList.remove("hide"),
        ...
        document
          .getElementById("average-calculator")
          .classList.remove("active"),
...
function sipCalculator() {
  ...
  a = a || 0;
  for (var o = 0; o < l; o++)
    (d += m), (s += m), (d *= 1 + n), (o + 1) % 12 == 0 && (m *= 1 + a / 100);
  var i = d - s;
  e &&
    t &&
    c &&
    ((document.getElementById("im").innerHTML = Number(
      s.toFixed(2)
    ).toLocaleString(intlLanguage)),
    (document.getElementById("tm").innerHTML = Number(
      d.toFixed(2)
    ).toLocaleString(intlLanguage)),
    (document.getElementById("gm").innerHTML = Number(
      i.toFixed(2)
    ).toLocaleString(intlLanguage)));
}
...
function calculateEMI() {
  ...
  e &&
    ...
    c &&
    (n.textContent =
      Number(a.toFixed(2)).toLocaleString(intlLanguage) + " per month");
}
...
function calculateSWP() {
  ...
  if (!(isNaN(e) || isNaN(t) || isNaN(c) || isNaN(a))) {
    for (var n = c / 1200, l = e, d = 0, s = 0; s < a; s++)
      (l = l * (1 + n) - t), (d += t);
    document.getElementById("swp-result").innerHTML =
      "Final value after " +
      a +
      " Months: " +
      l.toFixed(2) +
      "<br/><p>Total amount withdrawn: " +
      d.toFixed(2) +
      "</p>";
  }
}
function updateClock() {
  ...
  document.getElementById("clock") &&
    (document.getElementById("clock").innerText = l);
}
function isMobile() {
...
function updateSidebarVisibility() {
    ...
    var toggleOnOff = document.getElementById('toggle_on_off');
    if (sidebar.style.left === "-500px") {
        toggleOnOff.classList.remove("fa-toggle-on");
        toggleOnOff.classList.add("fa-toggle-off");
    } else {
        toggleOnOff.classList.add("fa-toggle-on");
        toggleOnOff.classList.remove("fa-toggle-off");
    }
}